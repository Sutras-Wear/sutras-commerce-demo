...
check('V25 cache-bust on CSS', 'styles.css?v=20260909-v26-1' in html)
check('V25 cache-bust on catalog JS', 'scripts/catalog.js?v=20260909-v26-1' in html)
check('V25 cache-bust on app JS', 'scripts/app.js?v=20260909-v26-1' in html)
...
print(f'V25 inherited regression static checks: {len(checks)} total, {len(failed)} failed')
for n,o in checks:
